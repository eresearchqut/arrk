...
setup(name='eresearchqut-arrk',
      version="1.0.0",
      packages=packages,
      description='TRRF Australian Registry for Rare Kidney Diseases',
      long_description='Australian Registry for Rare Kidney Diseases is a patient registry based on TRRF (https://github.com/eresearchqut/trrf).',
